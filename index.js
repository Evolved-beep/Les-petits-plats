...
inputApp.addEventListener("click", function () {
  ...
  if (appliance_list.style.display === "block") {
    return (appliance_list.style.display = "none") && icon.classList.remove("rotate")
  } else {
    return (appliance_list.style.display = "block") && icon.classList.add("rotate")
  }
});
...
input.addEventListener("click", function () {
  ...
  const icon = document.querySelector(".usten")
  console.log(icon)
  if (ustensil_list.style.display === "block") {
    (ustensil_list.style.display = "none") && icon.classList.remove("rotate")
  } else {
    (ustensil_list.style.display = "block") && icon.classList.add("rotate")
  }
});
const filterArray = () => {
  let ingredientList = [];
